...
- [PHONE_SETUP_GUIDE.md](guides/PHONE_SETUP_GUIDE.md)
- [QUICK_DEPLOY_COMMANDS.md](guides/QUICK_DEPLOY_COMMANDS.md)
- [AUTO_LEARNING_GUIDE.md](guides/AUTO_LEARNING_GUIDE.md)

### `reports/`

Status snapshots, reviews, and implementation summaries.

### `archive/`

Older working notes and one-off instructions that are still useful for historical context.

Some archive files still mention the old root-level layout because they are preserved as historical notes.
